metadata {
    definition (name: "RPi Home Monitor", namespace: "asishvarghese/rpi_monitor", author: "Asish Varghese") {
...
def parse(String description) {
    ...
    log.debug "Parsing DT ${device.deviceNetworkId} ${usn} '${description}'"
    ...
    if (parsedEvent['body'] != null) {
        ...
        log.debug "Door Sensor: Processing command ${cmd} for ${targetUsn}"
...
def getRequest(path) {
    log.debug "Door Sensor: Sending request for ${path} from ${device.deviceNetworkId}"
